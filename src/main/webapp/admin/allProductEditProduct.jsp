...
<body>
<div style="color: white; text-align: center;margin-bottom:10px; font-size: 30px;">All Products & Edit Products <i class='fab fa-elementor'></i></div>
<% 
String msg = request.getParameter("msg");
if("added".equals(msg))
{
%>
<h3 class="alert">Product Successfully Added!</h3> 
<%} %>
<% 
